...
export default function Nav() {
  ...
  return (
    <>
      <header>
        <div className="px-3 py-2 mr-2 text-bg-dark border-bottom">
          <div className="container">
            ...
            <Link to="/" 
              ...
              >
                ...
                <span className="fs-3 "> &nbsp; Zidio Web Development </span>
              </Link>
              ...
              <ul className="nav col-12 col-lg-auto my-2 justify-content-center align-items-center my-md-0 text-small">
                ...
                {/* {!isLoggedIn ? (
                  ...
                  <li>
                    <button onClick={handleLogout} className="btn btn-outline-secondary btn-lg px-4">
                      Logout
                    </button>
                  </li>
                )} */}
