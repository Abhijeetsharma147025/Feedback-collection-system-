...
export default function Features() {
  const feature1 = {
    title: "Transform your ideas into Reality with Zidio Development",
  ...
  const feature2 = {
    title: "Responsiveness web Design",
  ...
  const feature4 = {
    ...
    desc: "A great website is one that can be easily found by your target audience. Zidio integrates advanced SEO strategies into the development process, helping your site rank higher in search engine results. Additionally, we optimize for speed and performance, ensuring quick load times and a seamless user experience..",
  };
  const feature5 = {
  ...
  const feature6 = {
    ...
    desc: "Restful APIs, GraphQL, and third-partyintegrations for seamless software interaction.",
  };
