          ...
          <div className="col">
            <div className="row row-cols-1 row-cols-sm-2 g-4">
              <div className="col d-flex flex-column gap-2">
                ...
                <p className="text-body-secondary">
                  Database Manager abhisharmaku099@gmail.com@gmail.com
                </p>
              </div>
              ...
              <div className="col d-flex flex-column gap-2">
                ...
                <p className="text-body-secondary">
                  Backend Developer abhi@gmail.com
                </p>
              </div>
              ...
              <div className="col d-flex flex-column gap-2">
                ...
                <p className="text-body-secondary">
                  Frontend Developer abhisharmaku@gmail.com
                </p>
              </div>
              ...
              <div className="col d-flex flex-column gap-2">
                ...
                <p className="text-body-secondary">
                  Assistant Backend Developer abhisharmaku099@gmail.com
                </p>
              </div>
            </div>
          </div>
