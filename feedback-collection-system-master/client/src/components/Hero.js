      ...
      <div className="container col-xxl-8 px-4 py-5">
        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
          ...
          <div className="col-lg-6">
            ...
            <h2 className="lead ">
              Web development, data science, Software development, android app
              development, data science, ui / ux design, frontend, backend, full
              stack, jobs, internship,Digital Marketing integration , Custom Software
              Development, Agile Methodologies, Data Analytics and Business
              Intelligence, E-commerce Solutions, E-commerce building
            </h2>
