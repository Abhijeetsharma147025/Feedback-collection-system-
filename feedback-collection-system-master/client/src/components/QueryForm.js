...
export default function QueryForm() {
  ...
  return (
    ...
    <div><Feedback/></div>
      ...
      <h1 className="text-center fw-bold" style={{ color: 'black', padding: '15px' }}> Query Form</h1>
      <form id="feedbackForm" style={{ backgroundColor: '#fff', padding: '50px' }} className="border border-secondary border-4 rounded" onSubmit={handleSubmit}>
          ...
          <label className="" htmlFor="query">Query:</label>
          <textarea id="query" name="query" placeholder="Type here..." value={query} onChange={(e)=>setQuery(e.target.value)} required/>
